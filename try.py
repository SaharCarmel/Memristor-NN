...
# dataloaders['train'] = tomanhattan_netrch.utils.data.DataLoader(
...
for epoch in range(1, args.epochs):    
    train(args, model, device, dataloaders['train'], dataloaders['val'] ,  test_iterator, model.criterion , epoch , _run)
